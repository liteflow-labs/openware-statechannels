// Source: https://github.com/statechannels/statechannels/blob/44c88c10f674745c741ecfaa7bebb15bb15323e8/packages/nitro-protocol/contracts/examples/SingleAssetPayments.sol
...
contract SingleAssetPayments is IForceMoveApp {
    ...
    function validTransition(
        ...
        Outcome.OutcomeItem[] memory outcomeA = abi.decode(
            a.outcome,
            (Outcome.OutcomeItem[])
        );
        Outcome.OutcomeItem[] memory outcomeB = abi.decode(
            b.outcome,
            (Outcome.OutcomeItem[])
        );
        ...
        require(
            ...
            '|AllocationA|!=|participants|'
        );
        require(
            allocationB.length == nParticipants,
            '|AllocationB|!=|participants|'
        );
